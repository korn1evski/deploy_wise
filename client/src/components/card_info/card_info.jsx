...
const Card = (props) => {
    const copyToClipboard = () => {
        ...
        const svgElement = document.getElementById('copyIcon');
        ...
        <div className='card-container'>
            <div className = 'card'>
                <div className='header'>
                    {"Summary"}
                    <svg id='copyIcon' className='svgicon' onClick={copyToClipboard} xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
